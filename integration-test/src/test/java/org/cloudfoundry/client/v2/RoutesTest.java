...
public final class RoutesTest extends AbstractIntegrationTest {
    ...
    public void associateApplication() throws TimeoutException, InterruptedException {
        ...
        Mono
            ...
            .untilOtherFrom(function((applicationId, routeId) -> associateApplicationWithRoute(this.cloudFoundryClient, applicationId, routeId)))
    ...
    public void delete() throws TimeoutException, InterruptedException {
        ...
        Mono
            ...
            .untilOtherFrom(routeId -> this.cloudFoundryClient.routes()
    ...
    public void exists() throws TimeoutException, InterruptedException {
        ...
        Mono
            ...
            .untilOtherFrom(function((domainId, spaceId) -> this.cloudFoundryClient.routes()
                .create(CreateRouteRequest.builder()
                    .domainId(domainId)
                    .host(hostName)
                    .spaceId(spaceId)
    ...
    public void listApplicationsFilterByOrganizationId() throws TimeoutException, InterruptedException {
        ...
        this.organizationId
            ...
            .untilOtherFrom(function((applicationId, routeId, organizationId) -> associateApplicationWithRoute(this.cloudFoundryClient, applicationId, routeId)))
    ...
    public void listApplicationsFilterBySpaceId() throws TimeoutException, InterruptedException {
        ...
        Mono
            ...
            .untilOtherFrom(function((applicationId, routeId, spaceId) -> associateApplicationWithRoute(this.cloudFoundryClient, applicationId, routeId)))
    ...
    public void listApplicationsFilterByStackId() throws TimeoutException, InterruptedException {
        ...
        Mono
            ...
            .untilOtherFrom(function((applicationId, routeId, stackId) -> associateApplicationWithRoute(this.cloudFoundryClient, applicationId, routeId)))
    ...
    public void listFilterByDomainId() throws TimeoutException, InterruptedException {
        ...
        Mono
            ...
            .untilOtherFrom(function((domainId, spaceId) -> requestCreateRoute(this.cloudFoundryClient, domainId, spaceId)))
    ...
    public void listFilterByOrganizationId() throws TimeoutException, InterruptedException {
        ...
        this.organizationId
            ...
            .untilOtherFrom(function((domainId, spaceId, organizationId) -> requestCreateRoute(this.cloudFoundryClient, domainId, spaceId)))
    ...
    public void removeApplication() throws TimeoutException, InterruptedException {
        ...
        Mono
            ...
            .untilOtherFrom(function((applicationId, routeId) -> associateApplicationWithRoute(this.cloudFoundryClient, applicationId, routeId)))
            .untilOtherFrom(function((applicationId, routeId) -> this.cloudFoundryClient.routes()
