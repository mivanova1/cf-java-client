    ...
    private Mono<ApplicationMetadata> pushServiceBroker(CloudFoundryClient cloudFoundryClient, String organizationId, String serviceName, String planName) {
        ...
        return Mono
            ...
            .flatMap(function((spaceId, domain) -> Mono
                ...
                .delayUntil(applicationId -> requestUploadApplication(cloudFoundryClient, applicationId, this.application)
                    .flatMap(job -> JobUtils.waitForCompletion(cloudFoundryClient, Duration.ofMinutes(5), job)))
                .delayUntil(applicationId -> requestUpdateApplication(cloudFoundryClient, applicationId, "STARTED", serviceName, planName))
                .delayUntil(applicationId -> requestGetApplication(cloudFoundryClient, applicationId)
