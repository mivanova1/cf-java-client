...
public final class OrganizationsTest extends AbstractIntegrationTest {
    ...
    public void delete() throws TimeoutException, InterruptedException {
        ...
        createOrganizationId(this.cloudFoundryClient, organizationName)
            .untilOtherFrom(organizationId -> this.cloudFoundryClient.organizations()
    ...
    public void listAuditors() throws TimeoutException, InterruptedException {
        ...
        Mono
            ...
            .untilOtherFrom(function((organizationId, userId) -> requestAssociateAuditor(this.cloudFoundryClient, organizationId, userId)))
            .flatMap(function((organizationId, userId) -> Mono.when(
                Mono.just(userId),
    ...
    public void listAuditorsFilterByAuditedOrganizationId() throws TimeoutException, InterruptedException {
        ...
        Mono
            ...
            .untilOtherFrom(function((organizationId1, organizationId2, userId) -> Mono.when(
    ...
    public void listAuditorsFilterByAuditedSpaceId() throws TimeoutException, InterruptedException {
        ...
        Mono
            ...
            .untilOtherFrom(function((organizationId, userId, spaceId) -> requestAssociateSpaceAuditor(this.cloudFoundryClient, spaceId, userId)))
    ...
    public void listAuditorsFilterByManagedSpaceId() throws TimeoutException, InterruptedException {
        ...
        Mono
            ...
            .untilOtherFrom(function((organizationId, userId, spaceId) -> requestAssociateSpaceManager(this.cloudFoundryClient, spaceId, userId)))
            .flatMap(function((organizationId, userId, spaceId) -> Mono.when(
                Mono.just(userId),
    ...
    public void listBillingManagers() throws TimeoutException, InterruptedException {
        ...
        Mono
            ...
            .untilOtherFrom(function((organizationId, userId) -> requestAssociateBillingManager(this.cloudFoundryClient, organizationId, userId)))
            .flatMap(function((organizationId, userId) -> Mono.when(
                Mono.just(userId),
    ...
    public void listDomainsPrivate() throws TimeoutException, InterruptedException {
        ...
        createOrganizationId(this.cloudFoundryClient, organizationName)
            .untilOtherFrom(organizationId -> createPrivateDomainId(this.cloudFoundryClient, organizationId, privateDomainName))
    ...
    public void listFilterByManagerId() throws TimeoutException, InterruptedException {
        ...
        Mono
            ...
            .untilOtherFrom(function((organizationId, userId) -> requestAssociateManager(this.cloudFoundryClient, organizationId, userId)))
    ...
    public void listFilterByUserId() throws TimeoutException, InterruptedException {
        ...
        Mono
            ...
            .untilOtherFrom(function((organizationId, userId) -> requestAssociateUser(this.cloudFoundryClient, organizationId, userId)))
    ...
    public void listPrivateDomains() throws TimeoutException, InterruptedException {
        ...
        Mono
            ...
            .untilOtherFrom(function((organizationId, privateDomainId) -> requestAssociatePrivateDomain(this.cloudFoundryClient, organizationId, privateDomainId)))
    ...
    public void listSpaces() throws TimeoutException, InterruptedException {
        ...
        createOrganizationId(this.cloudFoundryClient, organizationName)
            .untilOtherFrom(organizationId -> requestCreateSpace(this.cloudFoundryClient, organizationId, spaceName))
    ...
    public void listSpacesFilterByDeveloperId() throws TimeoutException, InterruptedException {
        ...
        Mono
            ...
            .untilOtherFrom(function((organizationId, spaceId, userId) -> requestAssociateSpaceDeveloper(this.cloudFoundryClient, spaceId, userId)))
    ...
    public void removeAuditor() throws TimeoutException, InterruptedException {
        ...
        Mono
            ...
            .untilOtherFrom(function((organizationId, userId) -> requestAssociateAuditor(this.cloudFoundryClient, organizationId, userId)))
            .untilOtherFrom(function((organizationId, userId) -> this.cloudFoundryClient.organizations()
    ...
    public void removePrivateDomain() throws TimeoutException, InterruptedException {
        ...
        Mono
            ...
            .untilOtherFrom(function((organizationId, privateDomainId) -> requestAssociatePrivateDomain(this.cloudFoundryClient, organizationId, privateDomainId)))
            .untilOtherFrom(function((organizationId, privateDomainId) -> this.cloudFoundryClient.organizations()
