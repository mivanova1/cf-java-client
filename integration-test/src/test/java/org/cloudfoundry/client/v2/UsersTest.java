...
public final class UsersTest extends AbstractIntegrationTest {
    ...
    public void listAuditedOrganizations() throws TimeoutException, InterruptedException {
        ...
        createOrganizationId(this.cloudFoundryClient, organizationName)
            .untilOtherFrom(organizationId -> requestCreateUser(this.cloudFoundryClient, userId))
    ...
    public void listFilterByOrganization() throws TimeoutException, InterruptedException {
        ...
        this.organizationId
            .untilOtherFrom(organizationId -> requestCreateUser(this.cloudFoundryClient, userId))
            .untilOtherFrom(organizationId -> requestAssociateOrganization(this.cloudFoundryClient, organizationId, userId))
            .flatMapMany(organizationId -> PaginationUtils
                .requestClientV2Resources(page -> this.cloudFoundryClient.users()
                    .list(ListUsersRequest.builder()
                        .organizationId(organizationId)
    ...
    public void listFilterBySpace() throws TimeoutException, InterruptedException {
        ...
        this.organizationId
            .flatMap(organizationId -> createSpaceId(this.cloudFoundryClient, organizationId, spaceName))
            .untilOtherFrom(spaceId -> requestCreateUser(this.cloudFoundryClient, spaceId, userId))
            .untilOtherFrom(spaceId -> requestAssociateSpace(this.cloudFoundryClient, spaceId, userId))
            .flatMapMany(spaceId -> PaginationUtils
                .requestClientV2Resources(page -> this.cloudFoundryClient.users()
                    .list(ListUsersRequest.builder()
                        .page(page)
    ...
    public void update() throws TimeoutException, InterruptedException {
        ...
        this.organizationId
            .flatMap(organizationId -> createSpaceId(this.cloudFoundryClient, organizationId, spaceName))
            .untilOtherFrom(spaceId -> requestCreateUser(this.cloudFoundryClient, userId))
            .untilOtherFrom(spaceId -> this.cloudFoundryClient.users()
